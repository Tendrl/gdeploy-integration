...
def read_module_contents():
    with open('python_gdeploy/__init__.py') as app_init:
        return app_init.read()


def read_spec_contents():
    with open('python-gdeploy.spec') as spec:
        return spec.read()
...
class BumpCommand(Command):
    ...
    def run(self):
        ...
        module_file = read_module_contents()
        with open('python_gdeploy/__init__.py', 'w') as fileh:
        ...
        with open('python-gdeploy.spec', 'w') as fileh:
